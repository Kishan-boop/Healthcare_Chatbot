...
class QuestionDigonosis(Frame):
    ...
    def createWidget(self):
        ...
        self.btnClear.grid(row=25, column=1,columnspan=20,sticky="e")
...
class MainForm(Frame):
    ...
    def createWidget(self):
        ...
        self.lblTeam.pack()
        self.lblTeam1=Label(self, text="Amit Kumar", bg="RoyalBlue1", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam1.pack()
        self.lblTeam2=Label(self, text="Arun Gosain", bg="RoyalBlue2", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam2.pack()
        self.lblTeam3=Label(self, text="Kishan Kumar", bg="RoyalBlue3", width = "250", height = "1", font=("Calibri", 13))
        self.lblTeam3.pack()
        self.lblTeam3 = Label(self, text="Preeti", bg="RoyalBlue4", width="250", height="1", font=("Calibri", 13))
        self.lblTeam3.pack()
